...
public class MResultSet
{
     ...
     * Constructors
     *
     * @param req Le resultset d'une requete sql.
     */
    ...
    public double getDouble(String columnName) {
        if (!this.elements.containsKey(this.index)) {
            ...
            return this.elements.get(this.index).elements.containsKey(columnName) && this.elements.get(this.index).elements.get(columnName) != null ? Double.parseDouble(this.elements.get(this.index).elements.get(columnName).toString()) : -1.0D;
        }
    }
    ...
    private static class ResultSetRow
    {
        ...
        private ResultSetRow(HashMap<String, Object> elements) {
